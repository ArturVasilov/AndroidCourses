 ...
 * after all {@link org.andengine.entity.scene.ITouchArea}s have been checked and none consumed the {@link TouchEvent}.
 *
 * (c) 2012 Zynga Inc.
 *
...
public interface IOnSceneTouchListener {
	...
	/**
	 * Called when a {@link TouchEvent} is dispatched to a {@link org.andengine.entity.scene.Scene}.
	 *
	 * @param pScene The {@link org.andengine.entity.scene.Scene} that the {@link TouchEvent} has been dispatched to.
