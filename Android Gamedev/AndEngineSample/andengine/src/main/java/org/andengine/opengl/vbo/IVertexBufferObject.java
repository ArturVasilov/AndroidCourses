...
public interface IVertexBufferObject extends IDisposable {
	...
	/**
	 * Mark this {@link org.andengine.opengl.vbo.VertexBufferObject} as not not loaded to hardware.
	...
	/** Mark this {@link org.andengine.opengl.vbo.VertexBufferObject} dirty so it gets updated on the hardware. */
	public void setDirtyOnHardware();

	/**
	 * @return the number of <code>float</code>s that fit into this {@link org.andengine.opengl.vbo.IVertexBufferObject}.
	 */
	public int getCapacity();
	/**
	 * @return the number of <code>byte</code>s that fit into this {@link org.andengine.opengl.vbo.IVertexBufferObject}.
	 */
