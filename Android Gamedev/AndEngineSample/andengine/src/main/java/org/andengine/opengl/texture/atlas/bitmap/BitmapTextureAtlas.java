...
public class BitmapTextureAtlas extends TextureAtlas<IBitmapTextureAtlasSource> {
	...
	/**
	 * @param pBitmapTextureFormat use {@link BitmapTextureFormat#RGBA_8888} or {@link BitmapTextureFormat#RGBA_4444} for a {@link org.andengine.opengl.texture.atlas.bitmap.BitmapTextureAtlas} with transparency and {@link BitmapTextureFormat#RGB_565} for a {@link org.andengine.opengl.texture.atlas.bitmap.BitmapTextureAtlas} without transparency.
	 */
	...
	/**
	 * @param pBitmapTextureFormat use {@link BitmapTextureFormat#RGBA_8888} or {@link BitmapTextureFormat#RGBA_4444} for a {@link org.andengine.opengl.texture.atlas.bitmap.BitmapTextureAtlas} with transparency and {@link BitmapTextureFormat#RGB_565} for a {@link org.andengine.opengl.texture.atlas.bitmap.BitmapTextureAtlas} without transparency.
	 * @param pTextureAtlasStateListener to be informed when this {@link org.andengine.opengl.texture.atlas.bitmap.BitmapTextureAtlas} is loaded, unloaded or a {@link ITextureAtlasSource} failed to load.
	 */
	 ...
	 * Uses {@link BitmapTextureFormat#RGBA_8888}.
	 *
	 * @param pTextureOptions the (quality) settings of this {@link org.andengine.opengl.texture.atlas.bitmap.BitmapTextureAtlas}.
	 */
