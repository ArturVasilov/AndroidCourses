...
public class Gradient extends Shape {
	...
	/**
	 * Uses a default {@link org.andengine.entity.primitive.vbo.HighPerformanceGradientVertexBufferObject} in {@link DrawType#STATIC} with the {@link VertexBufferObjectAttribute}s: {@link org.andengine.entity.primitive.Gradient#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	...
	/**
	 * Uses a default {@link org.andengine.entity.primitive.vbo.HighPerformanceGradientVertexBufferObject} with the {@link VertexBufferObjectAttribute}s: {@link org.andengine.entity.primitive.Gradient#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	...
	/**
	 * @param pGradientFitToBounds If <code>true</code> ensures the from and to color are always on the bounds of the {@link org.andengine.entity.primitive.Gradient} entity.
	 * 								If <code>false</code> the from and to color might exceed the bounds of the {@link org.andengine.entity.primitive.Gradient} entity, depending on the angle/vector supplied.
	 */
