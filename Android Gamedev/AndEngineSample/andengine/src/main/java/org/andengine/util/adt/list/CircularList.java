 ...
 * Besides sparse allocations to increase the size of the internal Array, {@link org.andengine.util.adt.list.CircularList} is allocation free (unlike the {@link java.util.LinkedList} family).
 *
 * (c) 2012 Zynga Inc.
 *
 * @author Greg Haynes
