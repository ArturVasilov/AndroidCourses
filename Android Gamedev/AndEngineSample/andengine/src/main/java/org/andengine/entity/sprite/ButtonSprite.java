...
/**
 * Note: {@link org.andengine.entity.sprite.ButtonSprite} needs to be registered as a {@link org.andengine.entity.scene.ITouchArea} to the {@link org.andengine.entity.scene.Scene} via {@link org.andengine.entity.scene.Scene#registerTouchArea(org.andengine.entity.scene.ITouchArea)}, otherwise it won't be clickable.
 * To make {@link org.andengine.entity.sprite.ButtonSprite} function properly, you should consider setting {@link org.andengine.entity.scene.Scene#setTouchAreaBindingOnActionDownEnabled(boolean)} to <code>true</code>.
 *
 * (c) 2012 Zynga Inc.
 *
