...
/**
 * Compared to a {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject}, the {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject} uses <b><u>2x</u> the heap memory</b>,
 * at the benefit of significantly faster data buffering (<b>up to <u>5x</u> faster!</b>).
 *
 * @see {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} when to prefer a {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} instead of a {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject}
 *
