...
/**
 * Compared to {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject}, all {@link org.andengine.opengl.vbo.SharedMemoryVertexBufferObject}s share a single {@link java.nio.ByteBuffer} which is used by whichever {@link org.andengine.opengl.vbo.SharedMemoryVertexBufferObject} instance is currently buffering data,
 * at the cost of expensive data buffering (<b>up to <u>5x</u> slower!</b>) and a little synchronization overhead.
 * <p/>
 * Usually a {@link org.andengine.opengl.vbo.SharedMemoryVertexBufferObject} is preferred to a {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} when the following conditions need to be met:
 * <ol>
