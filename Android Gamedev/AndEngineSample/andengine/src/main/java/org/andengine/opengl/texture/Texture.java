...
public abstract class Texture implements ITexture {
	 ...
	 * @param pTextureStateListener to be informed when this {@link org.andengine.opengl.texture.Texture} is loaded, unloaded or a {@link org.andengine.opengl.texture.atlas.source.ITextureAtlasSource} failed to load.
	 */
