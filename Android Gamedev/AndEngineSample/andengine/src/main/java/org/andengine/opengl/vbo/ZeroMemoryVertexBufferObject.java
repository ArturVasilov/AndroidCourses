...
/**
 * Compared to a {@link HighPerformanceVertexBufferObject} or a {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject}, the {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} uses <b><u>no</u> permanent heap memory</b>,
 ...
 * <p/>
 * Usually a {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} is preferred to a {@link HighPerformanceVertexBufferObject} or a {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} when the following conditions are met:
 * <ol>
 * <li>The application is close to run out of memory.</li>
 * <li>You have very big {@link HighPerformanceVertexBufferObject}/{@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} or an extreme number of small {@link HighPerformanceVertexBufferObject}/{@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject}s, where you can't afford to have any of the bufferdata to be kept in heap memory.</li>
 * <li>The content (color, vertices, texturecoordinates) of the {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} is changed not often, or even better: never.</li>
 * </ol>
 * <p/>
 * (c) 2011 Zynga Inc.
 *
