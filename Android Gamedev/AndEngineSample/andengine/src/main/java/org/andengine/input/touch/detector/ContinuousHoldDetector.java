...
/**
 * Note: Needs to be registered as an {@link IUpdateHandler} to the {@link android.speech.tts.TextToSpeech.Engine} or {@link org.andengine.entity.scene.Scene} to work properly.
 *
...
public class ContinuousHoldDetector extends HoldDetector implements IUpdateHandler {
	...
	/**
	 * When {@link #isHolding()} this method will call through to {@link org.andengine.input.touch.detector.HoldDetector.IHoldDetectorListener#onHoldFinished(org.andengine.input.touch.detector.HoldDetector, long, int, float, float)}.
	 */
	@Override
	public void reset() {
		super.reset();
