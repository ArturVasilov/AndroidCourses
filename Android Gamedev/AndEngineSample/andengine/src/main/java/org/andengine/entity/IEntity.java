...
public interface IEntity extends IDrawHandler, IUpdateHandler, IDisposable, ITouchArea {
	 ...
	 * @param pEntityMatcher
	 * @return the first child (recursively!) that matches the supplied {@link IEntityMatcher} or <code>null</code> if none matches..
	 * @throws ClassCastException when the supplied {@link IEntityMatcher} matched an {@link org.andengine.entity.IEntity} that was not of the requested subtype.
	 */
	...
	/**
	 * Immediately sorts the {@link org.andengine.entity.IEntity}s based on their ZIndex. Sort is stable.
	 */
	public void sortChildren();
	/**
	 * Sorts the {@link org.andengine.entity.IEntity}s based on their ZIndex. Sort is stable.
	 ...
	 * If <code>false</code> the sorting is executed before the next (visible) drawing of the children of this {@link org.andengine.entity.IEntity}.
	 */
	public void sortChildren(final boolean pImmediate);
	/**
	 * Sorts the {@link org.andengine.entity.IEntity}s based on the {@link java.util.Comparator} supplied. Sort is stable.
	 ...
	 * to a {@link org.andengine.entity.scene.Scene} or the {@link Engine} itself, because otherwise
