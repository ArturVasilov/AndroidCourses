...
public interface IBuildableTextureAtlas<S extends ITextureAtlasSource, T extends ITextureAtlas<S>> extends ITextureAtlas<S> {
	 ...
	 * @deprecated Use {@link org.andengine.opengl.texture.atlas.buildable.IBuildableTextureAtlas#addTextureAtlasSource(org.andengine.opengl.texture.atlas.source.ITextureAtlasSource)} instead.
	 */
	@Deprecated
