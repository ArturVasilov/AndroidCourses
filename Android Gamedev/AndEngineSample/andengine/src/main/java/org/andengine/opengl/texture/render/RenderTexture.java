...
/**
 * The general workflow with a {@link org.andengine.opengl.texture.render.RenderTexture} is: {@link #init(org.andengine.opengl.util.GLState)} -> {@link #begin(org.andengine.opengl.util.GLState)} -> {@link #end(org.andengine.opengl.util.GLState)} -> {@link #destroy(org.andengine.opengl.util.GLState)}.
 *
 * (c) 2011 Zynga Inc.
 *
...
public class RenderTexture extends Texture {
	...
	/**
	 * @param pGLState
	 * @throws RenderTextureInitializationException when this {@link org.andengine.opengl.texture.render.RenderTexture} could not be initialized. The {@link GLException} contains the error code. When this exception is throw, all cleanup will be automatically performed through {@link #destroy(org.andengine.opengl.util.GLState)}.
	 */
	...
	/**
	 * @see {@link #end(org.andengine.opengl.util.GLState)},
	 * 		{@link #end(org.andengine.opengl.util.GLState, boolean, boolean}}.
	 */
	 ...
	 * 		{@link #end(org.andengine.opengl.util.GLState, boolean, boolean}}.
	 *
	 * @param pColor the {@link Color} to clear this {@link org.andengine.opengl.texture.render.RenderTexture}.
	 */
	 ...
	 * 		{@link #end(org.andengine.opengl.util.GLState, boolean, boolean}}.
	 *
	 * @param pRed the red portion of the color to clear this {@link org.andengine.opengl.texture.render.RenderTexture}.
	 * @param pGreen the green portion of the color to clear this {@link org.andengine.opengl.texture.render.RenderTexture}.
	 * @param pBlue the blue portion of the color to clear this {@link org.andengine.opengl.texture.render.RenderTexture}.
	 * @param pAlpha the alpha portion of the color to clear this {@link org.andengine.opengl.texture.render.RenderTexture}.
	 */
	...
	/**
	 * @see {@link #begin(org.andengine.opengl.util.GLState)},
	 * 		{@link #begin(org.andengine.opengl.util.GLState, boolean, boolean)},
	 * 		{@link #begin(org.andengine.opengl.util.GLState, Color)},
	 * 		{@link #begin(org.andengine.opengl.util.GLState, float, float, float, float)},
	 * 		{@link #begin(org.andengine.opengl.util.GLState, boolean, boolean, Color)}.
	 * 		{@link #begin(org.andengine.opengl.util.GLState, boolean, boolean, float, float, float, float)}.
	 */
