...
/**
 * Compared to a {@link HighPerformanceVertexBufferObject}, the {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} uses <b><u>50%</u> less heap memory</b>,
 * at the cost of significantly slower data buffering (<b>up to <u>5x</u> slower!</b>).
 *
 * Usually a {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} is preferred to a {@link HighPerformanceVertexBufferObject} when the following conditions are met:
 * <ol>
 ...
 * 	<li>The content (color, vertices, texturecoordinates) of the {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} is changed not often, or even better: never.</li>
 * </ol>
 *
 * (c) 2011 Zynga Inc.
 *
