...
/**
 * The general workflow with a {@link RenderTexture} is: {@link #init(org.andengine.opengl.util.GLState)} -> {@link #begin(org.andengine.opengl.util.GLState)} -> {@link #end(org.andengine.opengl.util.GLState)} -> {@link #destroy(org.andengine.opengl.util.GLState)}.
 *
 * (c) 2011 Zynga Inc.
 *
...
public class RenderTexture extends Texture {
	...
	/**
	 * @param pGLState
	 * @throws RenderTextureInitializationException when this {@link RenderTexture} could not be initialized. The {@link GLException} contains the error code. When this exception is throw, all cleanup will be automatically performed through {@link #destroy(org.andengine.opengl.util.GLState)}.
	 */
